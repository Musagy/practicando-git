...
- y por ultimo vamos a aprende como crear y eliminar ramas que esten en la nube
    - pero primero se tiene que crear una rama con
    ## git checkout -b "nombre de la rama"

    - ahora los cambios que hagas tienes que commitearlos
    - y para pusharlos tienes que usa
    ## git push origin "nombre de la rama"

    - despues cuando ya no la necesites puedes volver a master y fucionarlas con merge
    - despues de eso, usa
